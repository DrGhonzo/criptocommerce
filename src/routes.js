...
const interfaces = {
  ...
  plugins: {
    ...
    datatables: {
      ...
      EntityRows: lazy(() => import('views/interface/plugins/datatables/EditableRows/EntityRows')),
      DeviceRows: lazy(() => import('views/interface/plugins/datatables/EditableRows/DeviceRows')),
...
const routesAndMenuItems = {
  mainMenuItems: [
    ...
    },
    {
      ...
      icon: 'lock-on',
       subs: [
        { path: '/default', label: 'Alta/Baja/Modificacion de Divisas y precios', component: dashboards.default },
        { path: '/visual', label: 'Alta/Baja/Modificacion de Usuarios', component: dashboards.visual },
        { path: '/historial2', label: 'Notificaciones de sistema', component: apps.mailbox },
      ],
    },
    /*{
      path: `${appRoot}/apps`,
